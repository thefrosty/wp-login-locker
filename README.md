...
[![License](https://img.shields.io/packagist/l/thefrosty/wp-login-locker.svg)](https://packagist.org/thefrosty/wp-login-locker)
...
{
    "require": {
        "thefrosty/wp-login-locker": "^2.10"
    }
}
```
Then run:
...
`$ composer require thefrosty/wp-login-locker:^2.10`
